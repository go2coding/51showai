				...
				else if (!codeTag)
				{
					...
					if (lang !== '')
					{
			...
			else if (m[5][0] === ':' )
                        {
                                ...
                                if (codeTag && m[5] === codeFence)
                                {
                                        codeTag.pairWith(addEndTag('ANSWER', tagPos, tagLen, -1));
                                        addIgnoreTag(textBoundary, tagPos - textBoundary);
                                ...
                                {
                                        // Create code block
                                        codeTag   = addStartTag('ANSWER', tagPos, tagLen);
                                        codeFence = m[5].replace(/[^:~]+/, '');
                                        codeTag.setAttribute('blockDepth', blockDepth);
			...
			else if (m[5][0] === '%' )
                        {
                                ...
                                if (codeTag && m[5] === codeFence)
                                {
                                        codeTag.pairWith(addEndTag('QUESTION', tagPos, tagLen, -1));
                                        addIgnoreTag(textBoundary, tagPos - textBoundary);
                                ...
                                {
                                        // Create code block
                                        codeTag   = addStartTag('QUESTION', tagPos, tagLen);
                                        codeFence = m[5].replace(/[^%~]+/, '');
                                        codeTag.setAttribute('blockDepth', blockDepth);
