...
class InlineQuestion extends AbstractPass
{
	/**
	* {@inheritdoc}
	*/
	...
	*/
	protected function addInlineCodeTags($left, $right)
	{
		...
		$this->parser->addTagPair('QUESTION', $startPos, $startLen, $endPos, $endLen);
...
//file_put_contents('/var/www/bbs/storage/logs/log.txt', 'markers: '.var_export($markers,true), FILE_APPEND);
		return $markers;
	}
}
