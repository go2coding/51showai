...
use s9e\TextFormatter\Plugins\Litedown\Parser\Passes\BlocksAnswer;
...
use s9e\TextFormatter\Plugins\Litedown\Parser\Passes\InlineQuestion;
use s9e\TextFormatter\Plugins\Litedown\Parser\Passes\InlineAnswer;
...
class Parser extends ParserBase
{
	...
	*/
	public function parse($text, array $matches)
	{
		...
		//(new BlocksAnswer($this->parser, $text))->parse();
		...
		(new InlineQuestion($this->parser, $text))->parse();
		(new InlineAnswer($this->parser, $text))->parse();
