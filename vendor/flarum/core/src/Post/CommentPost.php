...
class CommentPost extends Post
{
    ...
    {
	//file_put_contents('/var/www/bbs/storage/logs/log.txt', var_export($content,true), FILE_APPEND);
    ...
    public function setPromptsAttribute($value)
    {
            $this->attributes['prompts'] = $value ;
    }
