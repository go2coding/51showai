...
class Formatter
{
	...
	$p_re = $parser->parse($text);
	//file_put_contents('/var/www/bbs/storage/logs/log.txt', $text, FILE_APPEND);
//file_put_contents('/var/www/bbs/storage/logs/log.txt', var_export($p_re,true), FILE_APPEND);
        return $p_re;
    }
