...
const styles = {
  ...
  question: { prefix: '%\n', suffix: '%', blockPrefix: '%%%', blockSuffix: '%%%' },
  answer: { prefix: ':', suffix: ':', blockPrefix: ':', blockSuffix: ':' },
...
function markdownToolbarItems(oldFunc) {
  ...
  items.add('question', <MarkdownButton title={tooltip('question')} icon="fas fa-question" onclick={makeApplyStyle('question')} />, 600);
  items.add('answer', <MarkdownButton title={tooltip('answer')} icon="fas fa-key" onclick={makeApplyStyle('answer')} />, 600);
